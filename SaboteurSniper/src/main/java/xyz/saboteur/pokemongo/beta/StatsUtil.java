...
public class StatsUtil {	
	public static double calculateCpMultiplier(PokemonData data) {
        ...
        return (meta.getBaseAttack() + data.getIndividualAttack()) * Math.sqrt(meta.getBaseDefense() + data.getIndividualDefense()) * Math.sqrt(meta.getBaseStamina() + data.getIndividualStamina());
    }
    ...
    public static double calculateMaxCpMultiplier(PokemonData data) {
    	PokemonMeta meta = PokemonMetaRegistry.getMeta(data.getPokemonId());
        return (meta.getBaseAttack() + 15) * Math.sqrt(meta.getBaseDefense() + 15) * Math.sqrt(meta.getBaseStamina() + 15);
    }
    ...
    public static double calculatePokemonPerfection(PokemonData data) {
        ...
        if (Math.abs(data.getCpMultiplier() + data.getAdditionalCpMultiplier()) <= 0)
            return (data.getIndividualAttack() * 2 + data.getIndividualDefense() + data.getIndividualStamina()) / (3.0/*4.0*/ * 15.0) * 100.0;
